...
export const resume = {
  ...
  experience: [
    {
      ...
      bullets: [
        ...
        "울주 AI센터의 NCP 네트워크·보안·배포 경로와 예약 API를 직접 구축했습니다. 2026년 8월 웹 요청 372,121건·예약 생성 294건을 처리했고, 동일 슬롯 중복 예약 없이 운영 중입니다.",
  ...
  projects: [
    ...
    },
    {
      ...
      subtitle: "NCP · CI/CD · 예약 동시성 제어",
      contribution: "공공기관 홈페이지의 NCP 네트워크·보안·배포 기반과 예약 API를 직접 구축했습니다.",
      technicalPoint: "로드밸런서·방화벽·보안 그룹을 구성하고, 배포 산출물·환경 설정을 분리해 이전 빌드로 복구할 수 있게 했습니다. 예약에는 낙관적 락과 요청 로그를 적용했습니다.",
    ...
    },
    {
      ...
      contribution: "울주 AI센터 연계 체험 서비스의 실시간 음성 대화 백엔드를 구현했습니다.",
      technicalPoint: "STT 인식부터 LLM 응답, TTS 음성 청크까지 이어지는 WebSocket 스트리밍 경로의 지연을 줄였습니다.",
