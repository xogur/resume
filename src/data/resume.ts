...
export const resume = {
  ...
  experience: [
    {
      ...
      bullets: [
        ...
        "병원 HIS 서비스의 보안과 NCP 블루그린 배포·복구 경로를 정비했습니다. 사진관리 기능은 접근 권한·감사 로그를 갖춘 별도 API로 분리해 HIS와 연동했습니다.",
  ...
  projects: [
    ...
    },
    {
      ...
      contribution: "병원 HIS 서비스의 환자정보 접근 경로와 배포 구조를 정비했습니다. 사진관리 기능은 별도 API로 분리해 HIS 화면과 연동했습니다.",
      technicalPoint: "NCP 사설망의 사진 API에 업무·지점별 권한 검증과 감사 로그를 적용했습니다. HIS 배포 후보의 준비 상태를 확인한 뒤 트래픽을 전환하고 이전 버전을 복구용으로 유지했습니다.",
      impact: "사진 API의 미인가 조회 거부와 검증 환경의 이상 로그인 알림을 확인했습니다. HIS 서비스의 실제 블루·그린 운영 전환 중 서비스 중단 기록은 없었습니다.",
    },
    {
